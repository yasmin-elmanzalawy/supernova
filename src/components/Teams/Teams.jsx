...
export default function Teams() {
  return (
    <div>
      <div className="bg-[#000000] overflow-hidden pt-24 md:pt-36 text-white">
        <div
        ...
        >
          ...
          <div className="md:flex justify-center items-center px-5 md:px-32 md:py-12">
            <div className="ceoimage m-5 md:w-[30%] ">
              <img className="rounded-xl rounded" src={abdelrahmanMesbah} alt="Ceo Image w-full" />
            </div>
            <div className="words md:text-xl md:w-[70%] md:px-12">
              <span className="font-bold md:text-2xl text-xl">Hi, and thanks for stopping by.</span> <br /> <br /> Supernova Gaming started as a
              small idea — just a few of us who loved esports and believed we
              could do something different.<br></br> We weren’t backed by big budgets or
              big names. Just passion, community, and the belief that great
              things can happen when people who care come together.<br></br> Today, we’ve
              grown into something bigger — a team, a brand, and a movement
              dedicated to building experiences that matter in the world of
              gaming.<br></br>Whether we’re running tournaments, creating content, or
              working with brands to connect with players, our goal is always to
              bring people closer to the games they love. <br></br>For us, esports isn’t
              just a trend — it’s a lifestyle. <br></br>It’s where friendships are made,
              careers are launched, and stories are written.<br></br> And at Supernova,
              we want to be the team that helps those stories come to life —
              especially here in the MENA region, where the potential is huge
              and the energy is real. <br></br>We’re still growing, still learning, and
              still dreaming big. But one thing will never change: we’re here
              for the players, the fans, and the future of gaming.<br></br><br></br><br></br> <span className="md:text-2xl text-xl font-bold"> Thanks for
              believing in us.<br></br> Founder Supernova Gaming</span>
            </div>
          </div>
